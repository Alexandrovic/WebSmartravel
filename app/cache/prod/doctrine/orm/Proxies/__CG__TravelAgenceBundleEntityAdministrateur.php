 ...
 */
class Administrateur extends \Travel\AgenceBundle\Entity\Administrateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'login', 'nom', 'prenom', 'eMail', 'password', 'image');
        }
