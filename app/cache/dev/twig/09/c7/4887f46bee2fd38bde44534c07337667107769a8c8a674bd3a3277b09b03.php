...
/* TravelAgenceBundle:Administrateur:index.html.twig */
class __TwigTemplate_09c74887f46bee2fd38bde44534c07337667107769a8c8a674bd3a3277b09b03 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("travel_admin_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 46
        echo $this->env->getExtension('routing')->getPath("travel_admin_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "TravelAgenceBundle:Administrateur:index.html.twig";
    }
