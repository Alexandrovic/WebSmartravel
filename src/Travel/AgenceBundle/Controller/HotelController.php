...
use Travel\AgenceBundle\Entity\Hotel;
use Travel\AgenceBundle\Form\HotelType;
...
class HotelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TravelAgenceBundle:Hotel')->findAll();

        return $this->render('TravelAgenceBundle:Hotel:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TravelAgenceBundle:Hotel:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TravelAgenceBundle:Hotel')->find($id);
        ...
        return $this->render('TravelAgenceBundle:Hotel:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TravelAgenceBundle:Hotel:edit.html.twig', array(
            'entity'      => $entity,
